...
export const SidebarProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (globalSetting?.favicon) {
      const versionedFavicon = `${globalSetting.favicon}${globalSetting.favicon.includes("?") ? "&" : "?"}v=${Date.now()}`;
      ...
      icon.setAttribute("href", versionedFavicon);
      ...
      appleIcon.setAttribute("href", versionedFavicon);
    }
  }, [globalSetting?.favicon, globalSetting?.shop_name]);
