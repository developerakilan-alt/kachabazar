    ...
    <>
      ...
      <AnimatedContent>
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          >
            <div className="grow scrollbar-hide w-full max-h-full space-y-6 pb-20">
              ...
              <Card className="border border-border">
                <CardHeader>
                  ...
                  <CardDescription>
                    Configure the available payment gateways for your store.
                  </CardDescription>
                </CardHeader>
              ...
              <Card className="border border-border">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    ...
                    <DocLink
                      section="/backend-configuration"
                      anchor="#next-auth-configuration"
                      label="Social login providers setup guide"
                    />
                  </CardTitle>
                  <CardDescription>
                    Enable options for customers to sign in using their social
                    accounts.
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-8">
              ...
              <Card className="border border-border">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    ...
                    <DocLink
                      section="/backend-configuration"
                      anchor="#google-analytics-configuration"
                      label="Analytics & chat integration guide"
                    />
                  </CardTitle>
                  <CardDescription>
                    Analytics and live chat integrations for your storefront.
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-8">
                  ...
                  <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                    <Label label={t("EnableFacebookPixel")} />
                    <div className="sm:col-span-4">
                      <SwitchToggle
                        id="facebook_pixel"
                  ...
                  >
                    <Label label={t("FacebookPixelKey")} />
                    <div className="sm:col-span-4">
                      <InputAreaTwo
                        required={enabledFbPixel}
                        register={register}
