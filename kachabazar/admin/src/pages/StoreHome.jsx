    ...
    <>
      ...
      <>
        <div className="w-full overflow-x-auto mb-6">
          <div className="flex items-center gap-1 border border-border rounded-xl p-2 bg-card min-w-max">
            <Link
        ...
        {(tabName === "home-settings" || tabName === null) && (
          <AnimatedContent>
            <div className="sm:container mx-auto bg-background rounded-lg">
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="flex justify-center py-6">
                  <button
                    ...
                    className="bg-primary text-white font-semibold shadow-md hover:opacity-90 transition-opacity"
                  >
                    {isSubmitting
                      ? "Processing..."
                      : isSave
        ...
        {tabName === "single-setting" && (
          <AnimatedContent>
            <div className="sm:container w-full mx-auto bg-background rounded-lg">
              <form onSubmit={handleSubmit(onSubmit)}>
                <SinglePage
                  isSave={isSave}
                  errors={errors}
