const setting = [
  {
    setting: {
      ...
      receipt_size: "57-mm",
      from_email: "sale@hautecouturejewellery.com",
      email_to_customer: false,
      allow_auto_trans: false,
      translation_key: "",
      enable_guest_order: true,
      ...
      email_port: "",
      email_user: "",
      email_pass: "", // stored encrypted

      // ── SMS/OTP Configuration (managed from admin) ──
      sms_provider: "mock",
      sms_sender_id: "hautecouturejewellery",
      app_name: "hautecouturejewellery",
      twilio_account_sid: "", // stored encrypted
      twilio_auth_token: "", // stored encrypted
      twilio_phone_number: "",
      twilio_messaging_service_sid: "", // stored encrypted
      messagebird_api_key: "", // stored encrypted
      vonage_api_key: "", // stored encrypted
      vonage_api_secret: "", // stored encrypted
      aws_access_key_id: "", // stored encrypted
  ...
  },
  {
    setting: {
      ...
      home: {
        ...
        daily_need_title: {
          en: "Get Your Daily Needs From Our hautecouturejewellery Store",
          de: "Holen Sie sich Ihren täglichen Bedarf in Ihrem CloudCleaver-Shop",
        },
        daily_need_description: {
          en: "There are many products you will find in our shop, Choose your daily necessary product from our hautecouturejewellery shop and get some special offers.",
          de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem hautecouturejewellery-Shop und erhalten Sie einige Sonderangebote.",
        },
      ...
      about_us: {
        ...
        top_title: {
          en: "Welcome to our hautecouturejewellery shop",
          de: "Willkommen in unserem hautecouturejewellery-Shop",
        },
        top_description: {
      ...
      term_and_condition:
 {
      ...
      faq: {
        ...
        faq_one: {
          en: "How does the hautecouturejewellery work?",
          de: "Wie funktioniert der hautecouturejewellery?",
        },
        description_one: {
        ...
        faq_five: {
          en: "What is hautecouturejewellery EC2 auto scaling?",
          de: "Was ist die automatische Skalierung von hautecouturejewellery EC2?",
        },
        description_five: {
          en: "Continually impact seamless imperatives for best-of-breed best practices. Phosfluorescently facilitate parallel applications with unique imperatives. Proactively plagiarize functionalized deliverables via inexpensive solutions. Collaboratively embrace web-enabled infomediaries rather than diverse testing procedures.",
        ...
        faq_six: {
          en: "What are the benefits of using hautecouturejewellery affliate?",
      ...
      seo: {
        favicon:
          "/logo/logo-color.png",
        meta_title: "hautecouturejewellery - React Next eCommerce Template",
        meta_description:
          "hautecouturejewellery is a React Next.js based grocery & organic food store eCommerce template. Shop fresh groceries, organic fruits, vegetables, dairy, and everyday essentials online with fast delivery.",
        meta_keywords:
          "ecommerce, online store, grocery store, organic food, fresh vegetables, fruits, dairy, react ecommerce, next.js store, hautecouturejewellery, online grocery, food delivery, organic products, health food, supermarket online",
        ...
        og_img:
          "https://res.cloudinary.com/ahossain/image/upload/v1636729752/facebook-page_j7alju.png",
        twitter_handle: "@hautecouturejewellery",
        google_verification: "",
        robots: "index, follow",
      },
    },
