...
export const metadata = {
  title: "Refund Policy",
  description:
    "Read our refund and return policy for hassle-free shopping.",
  keywords: ["refund", "return", "policy", "cancellation", "exchange"],
};

const RefundPolicy = async () => {
  const { storeCustomizationSetting, error } = await getCustomizationSettings();

  const refund_policy = storeCustomizationSetting?.refund_policy;

  return (
    <div className="min-h-screen bg-background">
      <PageHeader
        headerBg={refund_policy?.header_bg}
        ...
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-10">
          <div className="prose prose-sm sm:prose-base max-w-none dark:prose-invert">
            <CMSkeletonTwo
              ...
              error={error}
              loading={false}
              data={refund_policy?.description}
            />
            <br />
