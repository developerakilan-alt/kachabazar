  ...
  return (
    <div className="relative group">
      ...
      <div className="invisible opacity-0 group-hover:visible group-hover:opacity-100 absolute left-0 top-full z-50 w-[800px] transition-all duration-200 ease-in-out">
        <div className="mt-1 rounded-xl border border-border bg-white shadow-2xl overflow-hidden">
          <div className="flex">
            {/* Left: Category List */}
            <div className="w-56 border-r border-border bg-white py-4">
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-5 py-2.5 text-sm text-left transition-colors ${
                      activeCategory?._id === category._id
                        ? "bg-white text-primary font-medium border-r-2 border-primary"
